...
const lv_img_dsc_t bmp_pic = {
  .header.always_zero = 0,
  .header.w = 117,
  .header.h = 140,
  .data_size = 117*140 * LV_COLOR_SIZE / 8,
  .header.cf = LV_IMG_CF_TRUE_COLOR,
  .data = &bmp_public_buf[0],
};
const lv_img_dsc_t bmp_pic_117x92 = {
  .header.always_zero = 0,
  .header.w = 117,
  .header.h = 92,
  .data_size = 117*92 * LV_COLOR_SIZE / 8,
  .header.cf = LV_IMG_CF_TRUE_COLOR,
  .data = &bmp_public_buf[0],
};
const lv_img_dsc_t bmp_pic_100x100 = {
  .header.always_zero = 0,
  .header.w = 100,
  .header.h = 100,
...
const lv_img_dsc_t bmp_pic_100x40 = {
  .header.always_zero = 0,
  .header.w = 100,
  .header.h = 40,
  .data_size = 100*40 * LV_COLOR_SIZE / 8,
  .header.cf = LV_IMG_CF_TRUE_COLOR,
  .data = &bmp_public_buf[0],
};

const lv_img_dsc_t bmp_pic_150x80 = {
  .header.always_zero = 0,
  .header.w = 150,
  .header.h = 80,
  .data_size = 150*80 * LV_COLOR_SIZE / 8,
  .header.cf = LV_IMG_CF_TRUE_COLOR,
  .data = &bmp_public_buf[0],
};

const lv_img_dsc_t bmp_pic_45x45 = {
  .header.always_zero = 0,
  .header.w = 45,
  .header.h = 45,
  .data_size = 45*45 * LV_COLOR_SIZE / 8,
  .header.cf = LV_IMG_CF_TRUE_COLOR,
  .data = &bmp_public_buf[0],
};
...
void lv_tutorial_image(void)
{
	...
	//Pic_Read("bmp_return.bin", bmp_public_buf);
    ...
    pcfs_drv.file_size = 15600*2;//sizeof(pc_file_t);       /*Set up fields...*/
    pcfs_drv.letter = 'P';
    ...
    lv_img_set_src(img_bin, "P:/bmp_printing.bin");
#elif LV_COLOR_DEPTH == 16 && LV_COLOR_16_SWAP == 0
